<nav x-data="{ open: false }" class="text-white bg-indigo-900 border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('clinic')">
                        {{ __('Clinic') }}
                    </x-nav-link>
            ...
            <div class="hidden gap-4 sm:ml-6 sm:flex sm:items-center">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <x-dropdown-link :href="route('station.vital-sign')">
                            {{ __('Vital Sign') }}
                        </x-dropdown-link>
                        <x-dropdown-link :href="route('station.research')">
                            {{ __('Research Forms') }}
                        </x-dropdown-link>
                        <x-dropdown-link :href="route('station.clinical-encounter')">
                            {{ __('Clinical Encounter') }}
                        </x-dropdown-link>
                        <x-dropdown-link :href="route('station.pharmacy-order')">
                            {{ __('Pharmacy Order') }}
                        </x-dropdown-link>
                    </x-slot>
                </x-dropdown>
