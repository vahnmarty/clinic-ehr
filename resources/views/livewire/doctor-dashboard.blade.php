            ...
            <div class="lg:grid lg:grid-cols-12 lg:gap-x-16">
                <div class="mt-10 text-center lg:col-start-8 lg:col-end-13 lg:row-start-1 lg:mt-9 xl:col-start-9">
                  ...
                  -->
                    ...
                    -->
                        ...
                        <button type="button"
                            ...
                            <time datetime="2022-01-12"
                                class="flex items-center justify-center mx-auto rounded-full h-7 w-7">12</time>
                        </button>
                        <button type="button" class="bg-white py-1.5 text-gray-900 hover:bg-gray-100 focus:z-10">
                        ...
                        <button type="button" class="bg-white py-1.5 text-gray-900 hover:bg-gray-100 focus:z-10">
                            <time datetime="2022-01-22"
                                class="flex items-center justify-center mx-auto font-semibold text-white bg-gray-900 rounded-full h-7 w-7">22</time>
                        </button>
                        <button type="button" class="bg-white py-1.5 text-gray-900 hover:bg-gray-100 focus:z-10">
                    ...
                    <button type="button"
                        class="w-full px-4 py-2 mt-8 text-sm font-medium text-white bg-indigo-600 border border-transparent rounded-md shadow hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Add
                        event</button>
                </div>
                <ol class="mt-4 text-sm leading-6 divide-y divide-gray-100 lg:col-span-7 xl:col-span-8">
                            ...
                            <div class="flex-auto">
                                ...
                                <dl class="flex flex-col mt-2 text-gray-500 xl:flex-row">
                                    <div class="flex items-start space-x-3">
                                        ...
                                        <dd><time
                                                datetime="2022-01-10T17:00">{{ $app->created_at->format('F d, Y  h:i a') }}</time>
                                        </dd>
                                    </div>
                                    <div
                    ...
                    -->
                                <div class="absolute right-0 z-10 mt-2 origin-top-right bg-white rounded-md shadow-lg w-36 ring-1 ring-black ring-opacity-5 focus:outline-none"
